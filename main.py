...
class CaloriesCalculator(Calculator):
    ...
    # Почитать про докстринги здесь - https://peps.python.org/pep-0257/
...
class CashCalculator(Calculator):
    ...
    def get_today_cash_remained(self, currency,
        ...
        # единственный вариант.
            ...
            # Также в format/f-strings не должно быть никаких вычислений.
            return 'Денег нет, держись:' \
...
# Надо исправить:
# Обрати внимание, исполняемый код в .py-файлах должен быть закрыт  
